...
public enum TFM_PlayerRank
{
    ...
    DLG("the " + ChatColor.BLUE + "Master Ass Kicker" + ChatColor.AQUA + "of" + ChatColor.BLUE + "PumpkinFreedom!" + ChatColor.AQUA + "and a " + ChatColor.RED + "System-Admin!", ChatColor.translateAlternateColorCodes('&', "&8[&5Master&8-&6Ass&8-&2Kicker&8]&9")),
    CREEPER("the " + ChatColor.GREEN + "Creeper " + ChatColor.AQUA + "of " + ChatColor.BLUE + "PumpkinFreedom! " + ChatColor.AQUA + "and a " + ChatColor.RED + "System-Admin!", ChatColor.translateAlternateColorCodes('&', "&8[&eCreeper + &4Sys-Admin&8]")),
    CO_OWNER("a " + ChatColor.BLUE + "Co-Owner" + ChatColor.AQUA + " of " + ChatColor.YELLOW + "PumpkinFreedom", ChatColor.BLUE + "[Co-Owner]"),
